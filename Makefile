# This Makefile is for the HTML::TagTree extension to perl.
#
...
#     ABSTRACT => q[lib/HTML/TagTree.pm]
#     AUTHOR => q[daniel debrito <ddebrito@gmail.com>]
#     BUILD_REQUIRES => {  }
#     NAME => q[HTML::TagTree]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/HTML/TagTree.pm]
...
MAKE = make
FULLEXT = HTML/TagTree
BASEEXT = TagTree
PARENT_NAME = HTML
DLBASE = $(BASEEXT)
VERSION_FROM = lib/HTML/TagTree.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
PM_TO_BLIB = lib/HTML/TagTree.pm \
	blib/lib/HTML/TagTree.pm \
	lib/test_stuff.pl \
	blib/lib/test_stuff.pl \
	lib/test_destroy.pl.log \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/HTML/TagTree.pm $(INST_MAN3DIR)/HTML::TagTree.$(MAN3EXT) \
	  lib/test_stuff.pl $(INST_MAN3DIR)/test_stuff.$(MAN3EXT) \
	  lib/test_destroy.pl $(INST_MAN3DIR)/test_destroy.$(MAN3EXT) \
	  lib/test_get_html_text.pl $(INST_MAN3DIR)/test_get_html_text.$(MAN3EXT) 
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/HTML/TagTree.pm blib/lib/HTML/TagTree.pm \
